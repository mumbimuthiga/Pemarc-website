...
class JFormFieldCkpro extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html[] = \Sliderck\CKText::_('SLIDERCK_USE_PRO_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/documentation/miscellaneous/202-license-code" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . \Sliderck\CKText::_('SLIDERCK_GET_LICENCE_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
