...
class JFormFieldCkheight extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html .= '<div id="ckheightfieldhelp" style="display: none;"><h3>' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_FIELD_HELP_TITLE') . '</h3>
		<p>' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_FIELD_HELP_1') . '</p>
		<p><b>' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_FIELD_HELP_2') . '</b></p>
		<p>' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_FIELD_HELP_3') . '</p>
		<p>' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_FIELD_HELP_4') . '</p>
		<p style="text-align:center;padding:10px;font-size: 18px;">1280 x 800 px</p>
		<p>' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_FIELD_HELP_5') . '</p>
		<p><b>' . \Sliderck\CKText::_('SLIDERCK_CALCULATOR') . '</b></p>
		<p><label for="ckheightfieldhelpheight">' . \Sliderck\CKText::_('SLIDERCK_HEIGHT_LABEL') . '</label><input type="text" id="ckheightfieldhelpheight" onchange="ckHeightFieldHelpCalculator()"/></p>
		<p><label for="ckheightfieldhelpwidth">' . \Sliderck\CKText::_('SLIDERCK_WIDTH_LABEL') . '</label><input type="text" id="ckheightfieldhelpwidth" onchange="ckHeightFieldHelpCalculator()" /></p>
		<p><label for="ckheightfieldhelpratio">' . \Sliderck\CKText::_('SLIDERCK_RATIO_LABEL') . '</label><input type="text" id="ckheightfieldhelpratio" style="font-size: 18px;" /></p>
