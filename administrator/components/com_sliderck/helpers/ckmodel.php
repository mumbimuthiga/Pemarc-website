...
class CKModel {
	...
	function __construct() {
		...
		$this->state = new \Sliderck\CKObject;
	}
	...
	static function getInstance($name, $prefix, $config) {
		...
		if (!class_exists($class))
		{
			...
			{
//				throw new \InvalidArgumentException(\Sliderck\CKText::sprintf('ERROR_INVALID_MODEL', $type, $format));
		...
		if (!class_exists($class))
		{
			throw new \InvalidArgumentException(\Sliderck\CKText::sprintf('ERROR_INVALID_MODEL_CLASS', $class));
		}
