...
class JFormFieldCkstyle extends \Joomla\CMS\Form\FormField
{
	...
	protected function getInput() {
		...
		$html .= '<div class="btn" onclick="CKBox.open({url: \'index.php?option=com_sliderck&view=styles&tmpl=component&layout=modal\', style: {padding: \'10px\'}})">' . \Sliderck\CKText::_('MOD_SLIDERCK_SELECT') . '</div>';
		$html .= '<div class="btn" onclick="CKBox.open({url: \'index.php?option=com_sliderck&view=style&tmpl=component&layout=modal&id=\'+jQuery(\'#' . $this->id . '\').val()+\'\'})">' . \Sliderck\CKText::_('MOD_SLIDERCK_EDIT') . '</div>';
