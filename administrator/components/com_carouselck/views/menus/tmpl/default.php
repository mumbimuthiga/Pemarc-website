...
?>
<h3><?php echo \Carouselck\CKText::_('CK_MENU_ITEMS') ?></h3>
<p><?php echo \Carouselck\CKText::_('CK_MENU_ITEMS_DESC') ?></p>
...
function ckShowItems(btn, menutype, parentid) {
	...
	var myurl = "<?php echo \Carouselck\CKUri::base(true) ?>/index.php?option=com_carouselck&task=menus.ajaxShowMenuItems&" + cktoken + "=1";
	$ck.ajax({
		type: "POST",
		url: myurl,
		data: {
