...
class JFormFieldCkcolor extends \Joomla\CMS\Form\FormField {
    ...
    protected function getPathToImages() {
        ...
        $rootpath = JPATH_ROOT;
        $httppath = trim(\Carouselck\CKUri::root(), "/");
    ...
    protected function getLabel() {
        ...
        if (!empty($this->description)) {
            $label .= ' title="' . htmlspecialchars(trim($text, ':') . '<br />' .
                            \Carouselck\CKText::_($this->description), ENT_COMPAT, 'UTF-8') . '"';
        }
