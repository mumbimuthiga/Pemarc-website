...
class JFormFieldCklight extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html[] = \Carouselck\CKText::_('CAROUSELCK_USE_FREE_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/joomla-extensions/carousel-ck" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . \Carouselck\CKText::_('CAROUSELCK_GET_PRO_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
...
//		}
	...
	protected function testParams() {
		if (is_file(JPATH_ROOT.'/plugins/system/carouselckparams/carouselckparams.php')) {
			$this->state = 'green';
			return \Carouselck\CKText::_('CAROUSELCK_USE_PRO_VERSION');
		}
		return false;
	}
}