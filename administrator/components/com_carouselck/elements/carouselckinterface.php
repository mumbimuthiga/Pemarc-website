...
include_once JPATH_ROOT . '/administrator/components/com_carouselck/helpers/ckloader.php';

\Joomla\CMS\Form\FormHelper::loadFieldClass('hidden');
CKFramework::load();

class JFormFieldCarouselckinterface extends \Joomla\CMS\Form\Field\HiddenField
{
	/**
	 * The form field type.
	 *
