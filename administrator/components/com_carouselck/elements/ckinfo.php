...
';
		...
		$html .= '<div class="ckinfo"><i class="fas fa-thumbs-up"></i><a href="https://extensions.joomla.org/extension/carousel-ck/" target="_blank">' . \Carouselck\CKText::_('CAROUSELCK_VOTE_JED') . '</a></div>';
		$html .= '<div class="ckinfo"><i class="fas fa-info"></i><b>CAROUSEL CK</b> - ' . \Carouselck\CKText::_('CAROUSELCK_CURRENT_VERSION') . ' : <span class="label">' . $current_version . '</span></div>';
		$html .= '<div class="ckinfo"><i class="fas fa-file-alt"></i><a href="https://www.joomlack.fr/en/documentation/45-carousel-ck" target="_blank">' . \Carouselck\CKText::_('CAROUSELCK_DOCUMENTATION') . '</a></div>';
