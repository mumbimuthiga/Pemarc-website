...
class JFormFieldCkpro extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html[] = \Carouselck\CKText::_('CAROUSELCK_USE_PRO_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/documentation/miscellaneous/202-license-code" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . \Carouselck\CKText::_('CAROUSELCK_GET_LICENCE_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
