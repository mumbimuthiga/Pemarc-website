...
//		$doc->addScript(\Carouselck\CKUri::root(true) . '/media/jui/js/jquery.min.js');
...
//	}
	...
	?>
		<script src="<?php echo \Carouselck\CKUri::root(true) ?>/media/jui/js/jquery.min.js" type="text/javascript"></script>
		<link rel="stylesheet" href="<?php echo \Carouselck\CKUri::root(true) ?>/components/com_carouselck/assets/font-awesome.min.css" type="text/css" />
...
//		$item->imgthumb = $item->thumb;
	...
	static function setImageUrl($url) {
		if (strpos($url, 'http') !== 0) {
			$url = \Carouselck\CKUri::root(true) . '/' . $url;
		}
...
//		return $css;
	...
	public static function getProMessage() {
		$html = '<div class="ckinfo"><i class="fas fa-info"></i><a href="https://www.joomlack.fr/en/joomla-extensions/carousel-ck" target="_blank">' . \Carouselck\CKText::_('CAROUSELCK_ONLY_PRO') . '</a></div>';
	...
	public static function getProPreview($imgName) {
		$html = '<div class="ckpropreview">'
					...
					. '<a href="https://www.joomlack.fr/en/joomla-extensions/carousel-ck" target="_blank">' . \Carouselck\CKText::_('CAROUSELCK_ONLY_PRO') . '</a>'
				. '</div>';
