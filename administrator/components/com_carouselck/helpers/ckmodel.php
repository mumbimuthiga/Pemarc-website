...
class CKModel {
	...
	static function getInstance($name, $prefix, $config) {
		...
		if (!class_exists($class))
		{
			...
			{
//				throw new \InvalidArgumentException(\Carouselck\CKText::sprintf('ERROR_INVALID_MODEL', $type, $format));
		...
		if (!class_exists($class))
		{
			throw new \InvalidArgumentException(\Carouselck\CKText::sprintf('ERROR_INVALID_MODEL_CLASS', $class));
		}
