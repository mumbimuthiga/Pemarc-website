...
class SlideshowckViewStyle extends CKView {
	...
	function display($tpl = null) {
		...
		\Joomla\CMS\Toolbar\ToolbarHelper::title(Slideshowck\CKText::_('COM_SLIDESHOWCK') . ' - ' . Slideshowck\CKText::_('CK_EDITION'), 'logo_slideshowck_large.png');
	...
	protected function addToolbar() {
		...
		Slideshowck\CKFof::getApplication()->input->set('hidemainmenu', true);
		$user		= \Joomla\CMS\Factory::getUser();
		$userId		= $user->get('id');
