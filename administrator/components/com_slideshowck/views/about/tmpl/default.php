...
<div class="ckcenter"><a href="https://www.joomlack.fr/en/joomla-extensions/slideshow-ck" target="_blank" class="btn btn-small btn-inverse"><?php echo Slideshowck\CKText::_('Get the Pro version'); ?></a></div>
<p class="ckcenter"><a href="https://www.joomlack.fr" target="_blank">https://www.joomlack.fr</a></p>
<div class="alert ckcenter"><a href="https://extensions.joomla.org/extensions/extension/photos-a-images/slideshow/slideshow-ck" target="_blank" class="btn btn-small btn-warning"><?php echo Slideshowck\CKText::_('SLIDESHOWCK_VOTE_JED'); ?></a></div>
<div class="ckcenter"><a href="https://www.joomlack.fr/en/documentation/48-slideshow-ck" target="_blank"><?php echo Slideshowck\CKText::_('SLIDESHOWCK_DOCUMENTATION')  ?></a></div>
<hr />