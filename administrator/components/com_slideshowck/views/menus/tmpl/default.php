...
?>
<h3><?php echo Slideshowck\CKText::_('CK_MENU_ITEMS') ?></h3>
<p><?php echo Slideshowck\CKText::_('CK_MENU_ITEMS_DESC') ?></p>
...
function ckShowItems(btn, menutype, parentid) {
	...
	var myurl = "<?php echo Slideshowck\CKUri::base(true) ?>/index.php?option=com_slideshowck&task=menus.ajaxShowMenuItems&" + cktoken + "=1";
	$ck.ajax({
		type: "POST",
		url: myurl,
		data: {
