...
class CKFormField extends CKFormFieldBase {
	...
	public function __construct() {
		$this->mediaPath = Slideshowck\CKUri::root(true) . '/media/com_slideshowck/images/';
	...
	protected function getOptions() {
		...
		foreach ($this->element->children() as $option) {
			...
			$tmp = \Joomla\CMS\HTML\HTMLHelper::_(
							...
							Slideshowck\CKText::alt(trim((string) $option), preg_replace('/[^a-zA-Z0-9_\-]/', '_', $this->fieldname)), 'value', 'text',
