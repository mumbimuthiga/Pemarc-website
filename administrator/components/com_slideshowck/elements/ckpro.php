...
class JFormFieldCkpro extends CKFormField {
	...
	protected function getInput() {
		...
		$html[] = Slideshowck\CKText::_('SLIDESHOWCK_USE_PRO_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/documentation/miscellaneous/202-license-code" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . Slideshowck\CKText::_('SLIDESHOWCK_GET_LICENCE_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
