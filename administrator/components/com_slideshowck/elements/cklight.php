...
class JFormFieldCklight extends CKFormField {
	...
	protected function getInput() {
		...
		$html[] = Slideshowck\CKText::_('SLIDESHOWCK_USE_FREE_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/joomla-extensions/slideshow-ck" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . Slideshowck\CKText::_('SLIDESHOWCK_GET_PRO_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
...
//		}
	...
	protected function testParams() {
		if (is_file(JPATH_ROOT.'/plugins/system/slideshowckparams/slideshowckparams.php')) {
			$this->state = 'green';
			return Slideshowck\CKText::_('SLIDESHOWCK_USE_PRO_VERSION');
		}
		return false;
	}
}