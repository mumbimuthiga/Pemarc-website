...
class JFormFieldCkheight extends JFormFieldCkheightBase {
	...
	protected function getInput() {
		...
		$html .= '<div id="ckheightfieldhelp" style="display: none;"><h3>' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_FIELD_HELP_TITLE') . '</h3>
		<p>' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_FIELD_HELP_1') . '</p>
		<p><b>' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_FIELD_HELP_2') . '</b></p>
		<p>' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_FIELD_HELP_3') . '</p>
		<p>' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_FIELD_HELP_4') . '</p>
		<p style="text-align:center;padding:10px;font-size: 18px;">1280 x 800 px</p>
		<p>' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_FIELD_HELP_5') . '</p>
		<p><b>' . Slideshowck\CKText::_('SLIDESHOWCK_CALCULATOR') . '</b></p>
		<p><label for="ckheightfieldhelpheight">' . Slideshowck\CKText::_('SLIDESHOWCK_HEIGHT_LABEL') . '</label><input type="text" id="ckheightfieldhelpheight" onchange="ckHeightFieldHelpCalculator()"/></p>
		<p><label for="ckheightfieldhelpwidth">' . Slideshowck\CKText::_('SLIDESHOWCK_WIDTH_LABEL') . '</label><input type="text" id="ckheightfieldhelpwidth" onchange="ckHeightFieldHelpCalculator()" /></p>
		<p><label for="ckheightfieldhelpratio">' . Slideshowck\CKText::_('SLIDESHOWCK_RATIO_LABEL') . '</label><input type="text" id="ckheightfieldhelpratio" style="font-size: 18px;" /></p>
