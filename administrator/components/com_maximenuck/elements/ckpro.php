...
class JFormFieldCkpro extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html[] = \Maximenuck\CKText::_('MAXIMENUCK_USE_PRO_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/documentation/miscellaneous/202-license-code" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . \Maximenuck\CKText::_('MAXIMENUCK_GET_LICENCE_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
