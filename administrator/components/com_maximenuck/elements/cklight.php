...
class JFormFieldCklight extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html[] = \Maximenuck\CKText::_('MAXIMENUCK_USE_FREE_VERSION');
		$html[] = ' <a href="https://www.joomlack.fr/en/joomla-extensions/maximenu-ck" target="_blank">';
		$html[] = '<span class="cklabel cklabel-info"><i class="fas fa-link"></i> ' . \Maximenuck\CKText::_('MAXIMENUCK_GET_PRO_INFOS') . '</label>';
		$html[] = '</a>';
		$html[] = '</div>';
	...
	// protected function testParams() {
		// if (is_file(JPATH_ROOT.'/plugins/system/maximenuckparams/maximenuckparams.php')) {
			// $this->state = 'green';
			// return \Maximenuck\CKText::_('MAXIMENUCK_USE_PRO_VERSION');
		// }
		// return false;
	// }
}