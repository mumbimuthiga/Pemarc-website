...
class JFormFieldCkmenu extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		function ckEditMenu() {
			...
			if (! menutype) {
				alert("' . \Maximenuck\CKText::_('MAXIMENUCK_PLEASE_SELECT_MENU') .'");
				return;
			}
		...
		$html .= '<div class="ckbutton" onclick="CKBox.open({url: \'index.php?option=com_maximenuck&view=joomlamenus&tmpl=component&layout=modal\', style: {padding: \'0px\'}})"><i class="fas fa-mouse-pointer "></i> ' . \Maximenuck\CKText::_('CK_SELECT') . '</div>';
		$html .= '<div class="ckbutton" onclick="ckEditMenu()"><i class="fas fa-edit"></i> ' . \Maximenuck\CKText::_('CK_EDIT') . '</div>';
