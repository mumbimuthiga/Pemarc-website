...
class JFormFieldCkheight extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html .= '<div id="ckheightfieldhelp" style="display: none;"><h3>' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_TITLE') . '</h3>
		<p>' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_1') . '</p>
		<p><b>' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_2') . '</b></p>
		<p>' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_3') . '</p>
		<p>' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_4') . '</p>
		<p style="text-align:center;padding:10px;font-size: 18px;">1280 x 800 px</p>
		<p>' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_FIELD_HELP_5') . '</p>
		<p><b>' . \Maximenuck\CKText::_('MAXIMENUCK_CALCULATOR') . '</b></p>
		<p><label for="ckheightfieldhelpheight">' . \Maximenuck\CKText::_('MAXIMENUCK_HEIGHT_LABEL') . '</label><input type="text" id="ckheightfieldhelpheight" onchange="ckHeightFieldHelpCalculator()"/></p>
		<p><label for="ckheightfieldhelpwidth">' . \Maximenuck\CKText::_('MAXIMENUCK_WIDTH_LABEL') . '</label><input type="text" id="ckheightfieldhelpwidth" onchange="ckHeightFieldHelpCalculator()" /></p>
		<p><label for="ckheightfieldhelpratio">' . \Maximenuck\CKText::_('MAXIMENUCK_RATIO_LABEL') . '</label><input type="text" id="ckheightfieldhelpratio" style="font-size: 18px;" /></p>
