...
class JFormFieldCkmaximenu extends \Joomla\CMS\Form\FormField {
	...
	protected function getInput() {
		...
		$html .= '<div class="ckbutton" onclick="CKBox.open({url: \'index.php?option=com_maximenuck&view=maximenus&tmpl=component&layout=modal\', style: {padding: \'0px\'}})"><i class="fas fa-mouse-pointer "></i> ' . \Maximenuck\CKText::_('CK_SELECT') . '</div>';
		$html .= '<div class="ckbutton" onclick="CKBox.open({url: \'index.php?option=com_maximenuck&view=maximenu&tmpl=component&layout=modal&menutype=\'+jQuery(\'#' . $this->id . '\').val()+\'\'})"><i class="fas fa-edit"></i> ' . \Maximenuck\CKText::_('CK_EDIT') . '</div>';
