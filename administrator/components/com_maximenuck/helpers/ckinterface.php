...
class CKInterface extends \stdClass {
	...
	<?php
		...
		?>
		<div class="ckrow">
			<label for="<?php echo $prefix; ?>backdropfilter"><?php echo CKText::_('CK_FILTER_LABEL'); ?></label>
			<img class="ckicon" src="<?php echo $this->imagespath ?>/function.png" />
			<select id="<?php echo $prefix; ?>backdropfilter" name="<?php echo $prefix; ?>backdropfilter" class="<?php echo $prefix; ?> cktip" style="width: 70px; border-radius: 0px;">
				<option value="none"><?php echo CKText::_('CK_NONE'); ?></option>
				<option value="blur"><?php echo CKText::_('CK_BLUR'); ?></option>
			</select>
			<input type="text" id="<?php echo $prefix; ?>backdropfiltervalue" name="<?php echo $prefix; ?>backdropfiltervalue" class="cktip <?php echo $prefix; ?>" style="width:150px;max-width: none;" />
		</div>
		<fieldset class="maximenu-fieldset">
			<legend><?php echo CKText::_('CK_TOPFIXED'); ?></legend>
			<div class="ckrow">
				<label for="<?php echo $prefix; ?>topfixedbackgroundcolorstart"><?php echo CKText::_('CK_BGCOLOR_LABEL'); ?></label>
				<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
				<input type="text" id="<?php echo $prefix; ?>topfixedbackgroundcolorstart" name="<?php echo $prefix; ?>topfixedbackgroundcolorstart" class="cktip <?php echo $prefix; ?> <?php echo $this->colorpicker_class; ?>" title="<?php echo CKText::_('CK_BGCOLOR_DESC'); ?>"/>
				<img class="ckicon" src="<?php echo $this->imagespath ?>/color.png" />
				<input type="text" id="<?php echo $prefix; ?>topfixedbackgroundcolorend" name="<?php echo $prefix; ?>topfixedbackgroundcolorend" class="cktip <?php echo $prefix; ?> <?php echo $this->colorpicker_class; ?>" title="<?php echo CKText::_('CK_BGCOLOR2_DESC'); ?>" onchange="ckCheckGradientImageConflict(this, '<?php echo $prefix; ?>backgroundimageurl')"/>
				<img class="ckicon" src="<?php echo $this->imagespath ?>/layers.png" />
				<input type="text" id="<?php echo $prefix; ?>topfixedbackgroundopacity" name="<?php echo $prefix; ?>topfixedbackgroundopacity" class="cktip <?php echo $prefix; ?>" style="width:45px;" title="<?php echo CKText::_('CK_BGOPACITY_DESC'); ?>"/>
			</div>
			<div class="ckrow">
				<label for="<?php echo $prefix; ?>topfixedbackdropfilter"><?php echo CKText::_('CK_FILTER_LABEL'); ?></label>
				<img class="ckicon" src="<?php echo $this->imagespath ?>/function.png" />
				<select id="<?php echo $prefix; ?>topfixedbackdropfilter" name="<?php echo $prefix; ?>topfixedbackdropfilter" class="<?php echo $prefix; ?> cktip" style="width: 70px; border-radius: 0px;">
					<option value="none"><?php echo CKText::_('CK_NONE'); ?></option>
					<option value="blur"><?php echo CKText::_('CK_BLUR'); ?></option>
				</select>
				<input type="text" id="<?php echo $prefix; ?>topfixedbackdropfiltervalue" name="<?php echo $prefix; ?>topfixedbackdropfiltervalue" class="cktip <?php echo $prefix; ?>" style="width:150px;max-width: none;" />
			</div>
		</fieldset>
		<?php 
	}
