...
class CKModel {
	...
	function __construct() {
		...
		$this->state = new \Maximenuck\CKObject;
	}
	...
	static function getInstance($name, $prefix, $config = array()) {
		...
		if (!class_exists($class))
		{
			...
			{
//				throw new \InvalidArgumentException(\Maximenuck\CKText::sprintf('ERROR_INVALID_MODEL', $type, $format));
		...
		if (!class_exists($class))
		{
			throw new \InvalidArgumentException(\Maximenuck\CKText::sprintf('ERROR_INVALID_MODEL_CLASS', $class));
		}
