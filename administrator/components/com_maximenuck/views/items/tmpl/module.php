...
<div class="ckinterface">
	<h3><?php echo \Maximenuck\CKText::_('CK_MODULE') ?></h3>
...
<thead>
	<tr>
		<th class="" style="width:20px;"><?php echo \Maximenuck\CKText::_('CK_ID') ?></th>
		<th class="" style="min-width:200px;text-align:left;"><?php echo \Maximenuck\CKText::_('CK_TITLE') ?></th>
		<th class="" style="min-width:200px;"><?php echo \Maximenuck\CKText::_('CK_TYPE') ?></th>
		<th class="" style="min-width:200px;"><?php echo \Maximenuck\CKText::_('CK_POSITION') ?></th>
	</tr>
</thead>
