...
<div style="display:flex;flex-wrap:wrap;">
	...
	<div class="ckcenter"><a href="https://www.joomlack.fr/en/joomla-extensions/maximenu-ck" target="_blank" class="btn btn-small btn-inverse"><?php echo \Maximenuck\CKText::_('Get the Pro version'); ?></a></div>
	<p class="ckcenter"><a href="https://www.joomlack.fr" target="_blank">https://www.joomlack.fr</a></p>
	<div class="alert ckcenter"><a href="https://extensions.joomla.org/extension/maxi-menu-ck/" target="_blank" class="btn btn-small btn-warning"><?php echo \Maximenuck\CKText::_('MAXIMENUCK_VOTE_JED'); ?></a></div>
	<div class="ckcenter"><a href="https://www.joomlack.fr/en/documentation/maximenu-ck" target="_blank"><?php echo \Maximenuck\CKText::_('MAXIMENUCK_DOCUMENTATION')  ?></a></div>
	<hr />
	</div>
</div>