...
<form action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_maximenuck&view=styles'.$appendUrl); ?>" method="post" name="adminForm" id="adminForm">
	<?php if ($isModal) { ?>
	<div id="ckheader">
		...
		<div class="ckheadermenu">
			<div class="ckheadertitle">MAXIMENUCK CK - <?php echo \Maximenuck\CKText::_('CK_STYLES'); ?></div>
		</div>
	</div>
