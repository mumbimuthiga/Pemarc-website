...
<?php if ($canEdit && \Maximenuck\CKFof::getApplication()->input->get('menutype')) { ?>
<form class="row-fluid" action="<?php echo \Joomla\CMS\Router\Route::_('index.php?option=com_maximenuck&view=migration');?>" method="post" name="adminForm" id="adminForm">
<div>
	<span class="hasTooltip btn btn-small btn-danger" style="display:block;margin:5px;" onclick="delete_all_values()" title="<?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_ALL_SETTINGS_DESC'); ?>"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_ALL_SETTINGS'); ?></span>
</div>
<div class="span12">
	<div class="row-fluid">
		<div>
			<ol class="sortable" id="sortable">
				...
				<li class="clearfix" data-alias="<?php echo $item->alias ?>" data-level="<?php echo $item->level ?>" data-id="<?php echo (int) $item->id; ?>" data-parent="<?php echo (int) $item->parent_id; ?>" data-newcol="<?php echo $item->params->get('maximenu_createcolumn', 0) ?>" data-colwidth="<?php echo $item->params->get('maximenu_colwidth', '180') ?>" data-home="<?php echo $item->home ?>">
					<div class="row itemwrapper">
						...
						<div>
							<span class="itemparamstate"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_NORMAL_STATE'); ?></span>
							<span class="btn-group waitrow">
								<span class="hasTooltip btn btn-small primary"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_MARGINS'); ?></span>
								...
								<span class="hasTooltip btn btn-small primary"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_PADDINGS'); ?></span>
								...
								<span class="hasTooltip btn btn-small primary"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_BORDERRADIUS'); ?></span>
								...
								<span class="hasTooltip btn btn-small btn-danger normalstate" onclick="delete_values_normal_state(this)" title="<?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_SETTINGS_DESC'); ?>"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_SETTINGS'); ?></span>
							</span>
						</div>
						<div>
							<span class="itemparamstate"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_HOVER_STATE'); ?></span>
							<span class="btn-group waitrow">
								<span class="hasTooltip btn btn-small primary"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_MARGINS'); ?></span>
								...
								<span class="hasTooltip btn btn-small btn-danger hoverstate" onclick="delete_values_hover_state(this)" title="<?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_SETTINGS_DESC'); ?>"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_SETTINGS'); ?></span>
							</span>
						</div>
						<div>
							<span class="itemparamstate"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_ACTIVE_STATE'); ?></span>
							<span class="btn-group waitrow">
								<span class="hasTooltip btn btn-small primary"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_MARGINS'); ?></span>
								...
								<span class="hasTooltip btn btn-small btn-danger activestate" onclick="delete_values_active_state(this)" title="<?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_SETTINGS_DESC'); ?>"><?php echo \Maximenuck\CKText::_('COM_MAXIMENUCK_DELETE_SETTINGS'); ?></span>
							</span>
						</div>
					</div>
					<?php
...
<?php } else {
	if (!$canEdit) echo \Maximenuck\CKText::_('COM_MENUMANAGERCK_NORIGHTS_TO_EDIT');
} ?>
</div>
</body>
<?php
