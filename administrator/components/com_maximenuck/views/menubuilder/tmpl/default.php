...
CKFof::addScriptInline(MAXIMENUCK_MEDIA_URI . '/assets/jquery-uick-custom.js');
CKFof::addScriptInline(MAXIMENUCK_MEDIA_URI . '/assets/admin.js');
CKFof::addScriptInline(MAXIMENUCK_MEDIA_URI . '/assets/menubuilder.js');

\Maximenuck\CKText::script('CK_AUTOLOADER');
\Maximenuck\CKText::script('COM_MAXIMENUCK_CREATE_COLUMN');
\Maximenuck\CKText::script('COM_MAXIMENUCK_CREATE_ROW');
\Maximenuck\CKText::script('CK_STYLES');
\Maximenuck\CKText::script('CK_EDITION');
\Maximenuck\CKText::script('COM_MAXIMENUCK_SUBMENUWIDTH');
\Maximenuck\CKText::script('COM_MAXIMENUCK_SUBMENUHEIGHT');
\Maximenuck\CKText::script('COM_MAXIMENUCK_SUBMENULEFTMARGIN');
\Maximenuck\CKText::script('COM_MAXIMENUCK_SUBMENUTOPMARGIN');
\Maximenuck\CKText::script('COM_MAXIMENUCK_FULLWIDTH');
\Maximenuck\CKText::script('COM_MAXIMENUCK_COLUMN_WIDTH');
\Maximenuck\CKText::script('CK_ADD_ITEM');
\Maximenuck\CKText::script('CK_AUTOLOADER_NO_SUBMENU');
\Maximenuck\CKText::script('CK_CONFIRM_UPDATE_TITLE');
\Maximenuck\CKText::script('CK_SAVE_BEFORE_EDIT');
\Maximenuck\CKText::script('CK_STATE');
\Maximenuck\CKText::script('COM_MAXIMENUCK_TAB');
...
<div id="ckheader">
	...
	<div class="ckheadermenu">
		...
		<a href="javascript:void(0)" onclick="window.parent.CKBox.close()" class="ckheadermenuitem ckcancel">
			<span class="fa fa-times cktip" data-placement="bottom" title="<?php echo \Maximenuck\CKText::_('CK_EXIT') ?>"></span>
			<span class="ckheadermenuitemtext"><?php echo \Maximenuck\CKText::_('CK_EXIT') ?></span>
		</a>
...
<div id="ckbody" class="ckinterface">
	...
	<div id="ckbutton-new-item" class="ckbutton" onclick="ckShowItemsSelection(this)"><i class="fas fa-plus" style="margin-right: 5px;"></i><?php echo \Maximenuck\CKText::_('CK_ADD_ROOT_ITEM'); ?></div>
...
<div id="ck-items-selection" style="display: none;">
	<div class="ck-title"><?php echo \Maximenuck\CKText::_('CK_SELECT_ITEM') ?></div>
	<div id="ck-items-selection-list">
		<div class="ck-item-selection" data-type="menuitem"><i class="fas fa-link"></i><?php echo \Maximenuck\CKText::_('CK_MENU_ITEM') ?></div>
		<div class="ck-item-selection" data-type="custom"><i class="fas fa-link"></i><?php echo \Maximenuck\CKText::_('CK_CUSTOM_ITEM') ?></div>
		<div class="ck-item-selection" data-type="module"><i class="fas fa-cube"></i><?php echo \Maximenuck\CKText::_('CK_MODULE') ?></div>
		<div class="ck-item-selection" data-type="image"><i class="fas fa-image"></i><?php echo \Maximenuck\CKText::_('CK_IMAGE') ?></div>
		<div class="ck-item-selection" data-type="heading"><i class="fas fa-heading"></i><?php echo \Maximenuck\CKText::_('CK_HEADING') ?></div>
	...
	<div class="ckinfo"><i class="fas fa-info"></i><a href="https://www.joomlack.fr/en/joomla-extensions/maximenu-ck" target="_blank"><?php echo \Maximenuck\CKText::_('MAXIMENUCK_SOURCE_PRO_ONLY') ?></a></div>
</div>
