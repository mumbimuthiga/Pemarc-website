...
$this->input =\Maximenuck\CKFof::getInput();
...
$items = array(
	(object) array(
		...
		, 'anchor_title' => ''
		, 'desc' => ''
		, 'fparams' => new \Maximenuck\CKRegistry()
		, 'menu_image' => ''
		, 'menu_icon' => ''
	...
	(object) array(
		...
		, 'anchor_title' => ''
		, 'desc' => ''
		, 'fparams' => new \Maximenuck\CKRegistry('{"maximenu_icon":"fa fa-plane"}')
		, 'menu_image' => ''
		, 'menu_icon' => ''
		, 'classe' => ' item6 parent'
		, 'liclass' => ''
	...
	(object) array(
		...
		, 'anchor_title' => ''
		, 'desc' => ''
		, 'fparams' => new \Maximenuck\CKRegistry('{"maximenu_icon":"fa fa-bus"}')
		, 'menu_image' => ''
		, 'menu_icon' => ''
		, 'classe' => ' item8'
		, 'liclass' => ''
	...
	(object) array(
		...
		, 'anchor_title' => ''
		, 'desc' => ''
		, 'fparams' => new \Maximenuck\CKRegistry('{"maximenu_icon":"fa fa-calendar"}')
		, 'menu_image' => ''
		, 'menu_icon' => ''
		, 'classe' => ' item9'
		, 'liclass' => ''
	...
	(object) array(
		...
		, 'anchor_title' => ''
		, 'desc' => ''
		, 'fparams' => new \Maximenuck\CKRegistry('{"maximenu_icon":"fa fa-cutlery"}')
		, 'menu_image' => ''
		, 'menu_icon' => ''
		, 'classe' => ' item10'
		, 'liclass' => ''
	...
	(object) array(
		...
		, 'anchor_title' => ''
		, 'desc' => ''
		, 'fparams' => new \Maximenuck\CKRegistry('{"maximenu_icon":"fa fa-car"}')
		, 'menu_image' => ''
		, 'menu_icon' => ''
...
if (file_exists(JPATH_ROOT.'/modules/mod_maximenuck/helper.php')) {
	...
	echo \Maximenuck\CKText::_('CK_MODULE_MAXIMENUCK_NOT_INSTALLED');
	die;
}
...
if ( $modulelayout === 'pushdown' ) {
	echo \Maximenuck\CKText::_('CK_PUSHDOWN_PREVIEW_NOT_AVAILABLE');
}