...
CKFof::addScriptInline(MAXIMENUCK_MEDIA_URI . '/assets/admin.js?ver=10.1.8');
CKFof::addScriptInline(MAXIMENUCK_MEDIA_URI . '/assets/style.js?ver=10.1.8');
...
<input type="hidden" id="id" name="id" value="<?php echo $this->item->id; ?>" />
	...
	<div class="errorck" style="margin:0 10px;">
		<?php echo \Maximenuck\CKText::_('CK_PLEASE_DO_NOT_USE_IE'); ?>
	</div>
	<?php } ?>
	...
	<div id="stylescontainer" style="min-width: 1300px;" class="animateck">
		...
		<?php } else { ?>
			<label for="name" style="display: inline-block;"><?php echo \Maximenuck\CKText::_('CK_NAME'); ?></label>
			<input type="text" id="name" name="name" value="<?php echo $this->item->name; ?>" />
		<?php } ?>
			<div id="styleswizard_options" class="styleswizard">
				<div class="ckinterfacetablink current" data-level="1" data-tab="tab_mainmenu" data-group="main"><?php echo \Maximenuck\CKText::_('CK_MAINMENU'); ?></div>
				<div class="ckinterfacetablink" data-level="1" data-tab="tab_submenu" data-group="main"><?php echo \Maximenuck\CKText::_('CK_SUBMENU'); ?></div>
				<div class="ckinterfacetablink" data-level="1" data-tab="tab_subsubmenu" data-group="main"><?php echo \Maximenuck\CKText::_('CK_SUBSUBMENU'); ?></div>
				<div class="ckinterfacetablink" data-level="1" data-tab="tab_fancy" data-group="main"><?php echo \Maximenuck\CKText::_('CK_FANCY'); ?></div>
				<div class="ckinterfacetablink" data-level="1" data-tab="tab_layout" data-group="main"><?php echo \Maximenuck\CKText::_('CK_LAYOUT'); ?></div>
				<div class="ckinterfacetablink" data-level="1" data-tab="tab_customcss" data-group="main"><?php echo \Maximenuck\CKText::_('CK_CUSTOM_CSS'); ?></div>
				<div class="ckinterfacetablink" data-level="1" data-tab="tab_presets" data-group="main"><?php echo \Maximenuck\CKText::_('CK_PRESETS'); ?></div>
				<div class="ckclr"></div>
				<div class="ckinterfacetab current hascol" data-level="1" id="tab_mainmenu" data-group="main">
					<div class="ckcol_left">
						<div class="ckinterfacetablink current" data-tab="tab_menustyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENUBAR'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemnormalstyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENULINK'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemdescstyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENULINK_DESC'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemhoverstyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENULINK_HOVER'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemactivestyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENULINK_ACTIVE'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemactivehoverstyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENULINK_ACTIVE_HOVER'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemparentarrow" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_PARENT_ARROW'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemparentstyles" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_MENULINK_PARENT'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level1itemicon" data-group="mainmenu"><?php echo \Maximenuck\CKText::_('CK_ITEM_ICON'); ?></div>
					</div>
				...
				<div class="ckinterfacetab hascol" data-level="1" id="tab_submenu" data-group="main">
					<div class="ckcol_left">
						<div class="ckinterfacetablink current" data-tab="tab_level2menustyles" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_SUBMENU'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level2itemnormalstyles" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_SUBMENULINK'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level2itemhoverstyles" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_SUBMENULINK_HOVER'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level2itemactivestyles" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_SUBMENULINK_ACTIVE'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level2itemparentarrow" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_PARENT_ARROW'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level2heading" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_COLUMN_HEADING'); ?></div>
						<div class="ckinterfacetablink" data-tab="tab_level2itemicon" data-group="submenu"><?php echo \Maximenuck\CKText::_('CK_ITEM_ICON'); ?></div>
					</div>
					<div class="ckcol_right">
				...
				<div class="ckinterfacetab hascol" data-level="1" id="tab_subsubmenu" data-group="main">
					<div class="ckcol_left">
						<div class="ckinterfacetablink current" data-tab="tab_level3menustyles" data-group="subsubmenu"><?php echo \Maximenuck\CKText::_('CK_SUBSUBMENU'); ?></div>
					</div>
					<div class="ckcol_right">
				...
				<div class="ckinterfacetab hascol" data-level="1" id="tab_fancy" data-group="main">
					<div class="ckcol_left">
						<div class="ckinterfacetablink current" data-tab="tab_fancycursor" data-group="fancy"><?php echo \Maximenuck\CKText::_('CK_FANCY'); ?></div>
					</div>
					<div class="ckcol_right">
				...
				<div class="ckinterfacetab" data-level="1" id="tab_customcss" data-group="main">
					<div id="customcssbuttons">
						<div class="customcssbutton btn" data-rule="|ID| { }"><?php echo \Maximenuck\CKText::_('CK_MENUBAR'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| li.maximenuck.level1 { }"><?php echo \Maximenuck\CKText::_('CK_MENULINK'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| li.maximenuck.level1:hover { }"><?php echo \Maximenuck\CKText::_('CK_MENULINK_HOVER'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| li.maximenuck.level1.active { }"><?php echo \Maximenuck\CKText::_('CK_MENULINK_ACTIVE'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| li.maximenuck div.floatck { }"><?php echo \Maximenuck\CKText::_('CK_SUBMENU'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| ul.maximenuck2 li.maximenuck { }"><?php echo \Maximenuck\CKText::_('CK_SUBMENULINK'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| ul.maximenuck2 li.maximenuck:hover { }"><?php echo \Maximenuck\CKText::_('CK_SUBMENULINK_HOVER'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| ul.maximenuck2 li.maximenuck.active { }"><?php echo \Maximenuck\CKText::_('CK_SUBMENULINK_ACTIVE'); ?></div>
						<div class="customcssbutton btn" data-rule="|ID| li.maximenuck div.floatck div.floatck { }"><?php echo \Maximenuck\CKText::_('CK_SUBSUBMENU'); ?></div>
					</div>
		...
		<div id="stylescontainerright">
			<div id="previewarea">
				...
				<div class="ckstylesheet">
					<div class="ckstylesheet">
						<?php /*<link type="text/css" href="<?php echo \Maximenuck\CKUri::root(true); ?>/modules/mod_maximenuck/themes/<?php echo $this->params->get('theme', 'blank'); ?>/css/maximenuck.php?monid=maximenuck_previewmodule" rel="stylesheet"> */ ?>
					</div>
				</div>
...
<script language="javascript" type="text/javascript">
	...
	jQuery(document).ready(function($){
		...
		addToggleButtonEvent('#styleswizard_options label.ckbutton');
	});
</script>
