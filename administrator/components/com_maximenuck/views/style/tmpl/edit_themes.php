...
?>
	...
	<div class="ckinterfacetablink current" data-level="2" data-tab="tab_themeshorizontal" data-group="themes"><?php echo \Maximenuck\CKText::_('CK_HORIZONTAL'); ?></div>
	<div class="ckinterfacetablink" data-level="2" data-tab="tab_themesvertical" data-group="themes"><?php echo \Maximenuck\CKText::_('CK_VERTICAL'); ?></div>
	<div class="clr"></div>
	</div>
	...
	<div class="ckinterfacetab current" id="tab_themeshorizontal" data-level="2" data-group="themes">
		<div class="clearfix" style="min-height:35px;margin: 0 5px;">
			...
			$folders = \Maximenuck\CKFolder::folders($folder_path);
			natsort($folders);
			$i = 1;
