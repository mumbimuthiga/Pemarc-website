...
<div class="ckinterface ckinterface-labels-big" id="ck-item-edition-item-params">
	...
	<div>
		<span class="ckoption-label">
			<?php echo \Maximenuck\CKText::_('CK_PREVIEW'); ?>
		</span>
	...
	<div>
		...
		<span class="ckoption-field">
			...
			<a class="ckbutton" href="javascript:void(0)" onclick="CKBox.open({handler: 'iframe', id: 'ckimagemanager', url: MAXIMENUCK.BASE_URL + '&view=browse&type=image&func=ckSelectFile&field=imageurl&tmpl=component'})" ><?php echo \Maximenuck\CKText::_('CK_SELECT'); ?></a>
			<a class="ckbutton" href="javascript:void(0)" onclick="$ck('#imageurl').val('');ckUpdateImagePreview();"><?php echo \Maximenuck\CKText::_('CK_CLEAN'); ?></a>
		</span>
		<div class="clr"></div>
	</div>
	<div>
	...
	<div class="ck-title"><?php echo \Maximenuck\CKText::_('CK_LINK'); ?></div>
	<div>
		<span class="ckoption-label">
			<?php echo \Maximenuck\CKText::_('CK_LINK'); ?>
		</span>
		<span class="ckoption-field">
	...
	<div>
		<span class="ckoption-label">
			<?php echo \Maximenuck\CKText::_('CK_CSS_CLASS'); ?>
		</span>
		<span class="ckoption-field">
...
function ckUpdateImagePreview(selector = '#ckimagepreview') {
	if ($ck('#imageurl').val()) {
		var imageurl = '<?php echo \Maximenuck\CKUri::root(true) ?>' +  '/' + $ck('#imageurl').val();
	} else {
		var imageurl = '';
	}
