...
<div class="ckinterface ckinterface-labels-big" id="ck-item-edition-item-styles">
	<div class="ck-title"><?php echo \Maximenuck\CKText::_('CK_STYLES'); ?></div>
	
	
	<div class="ckinterfacetablink current" data-level="1" data-tab="tab_itemnormalstyles" data-group="main"><?php echo \Maximenuck\CKText::_('CK_MENULINK'); ?></div>
	<div class="ckinterfacetablink" data-level="1" data-tab="tab_itemhoverstyles" data-group="main"><?php echo \Maximenuck\CKText::_('CK_MENULINK_HOVER'); ?></div>
	<div class="ckinterfacetablink" data-level="1" data-tab="tab_itemactivestyless" data-group="main"><?php echo \Maximenuck\CKText::_('CK_MENULINK_ACTIVE'); ?></div>
	<div class="ckinterfacetablink" data-level="1" data-tab="tab_submenustyles" data-group="main"><?php echo \Maximenuck\CKText::_('CK_SUBMENU'); ?></div>
	<div class="ckclr"></div>
