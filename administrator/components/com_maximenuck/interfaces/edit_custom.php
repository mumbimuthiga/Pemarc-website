...
<div class="ckinterface ckinterface-labels-big" id="ck-item-edition-item-params">
	...
	<div>
		<span class="ckoption-label">
			<?php echo \Maximenuck\CKText::_('CK_URL'); ?>
		</span>
	...
	<div>
		<span class="ckoption-label">
			<?php echo \Maximenuck\CKText::_('CK_LINK_TARGET'); ?>
		</span>
		<span class="ckoption-field">
			<select id="maximenu_targetattr" name="maximenu_targetattr" class="inputbox" >
				<option value=""><?php echo \Maximenuck\CKText::_('CK_DEFAULT'); ?></option>
				<option value="_blank"><?php echo \Maximenuck\CKText::_('CK_LINK_TARGET_NEW'); ?></option>
			</select>
		</span>
		<div class="clr"></div>
	</div>
