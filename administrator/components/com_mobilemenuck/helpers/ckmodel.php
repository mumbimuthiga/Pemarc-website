...
//		$this->state = new \Mobilemenuck\CKObject;
	}
	...
	static function getInstance($name, $prefix, $config = array()) {
		...
		if (!class_exists($class))
		{
			...
			{
//				throw new \InvalidArgumentException(\Mobilemenuck\CKText::sprintf('ERROR_INVALID_MODEL', $type, $format));
		...
		if (!class_exists($class))
		{
			throw new \InvalidArgumentException(\Mobilemenuck\CKText::sprintf('ERROR_INVALID_MODEL_CLASS', $class));
		}
