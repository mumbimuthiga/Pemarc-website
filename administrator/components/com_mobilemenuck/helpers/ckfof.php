...
class CKFof {
	...
	static protected $environment = 'com_mobilemenuck'; // for joomla only
...
//			, $db->quoteName('profile_key') . ' = ' . $db->quote('custom.%')
	...
	public static function getWebAssetManager() {
		if (empty(self::$webassetsmanager)) {
			self::$webassetsmanager = \Joomla\CMS\Factory::getApplication()->getDocument()->getWebAssetManager();
		}
	...
	public static function getModel($modelName, $classPrefix = 'Mobilemenuck') {
