...
\Mobilemenuck\CKText::script('MOD_MOBILEMENUCK_SAVE_CLOSE');

class JFormFieldMobilemenuckicon extends \Joomla\CMS\Form\FormField
{
...
function ckMobilemenuUpdateStyle(nothing, id, name) {
		...
		$html .= '<div class="btn btn-outline-secondary" onclick="CKBox.open({url: \'index.php?option=com_mobilemenuck&view=styles&tmpl=component&modal=1&returnFunc=ckMobilemenuSelectStyle\'})"><i class="fas fa-mouse-pointer "></i> ' . \Mobilemenuck\CKText::_('PLG_MOBILEMENUCK_SELECT') . '</div>';
		$html .= '<div class="btn btn-outline-secondary" onclick="if (jQuery(\'#' . $this->id . '\').val()) {CKBox.open({url: \'index.php?option=com_mobilemenuck&view=style&tmpl=component&modal=1&id=\'+jQuery(\'#' . $this->id . '\').val()+\'\'}) } else { alert(\'' . \Mobilemenuck\CKText::_('PLG_MOBILEMENUCK_SELECT_FIRST', true) . '\');}"><i class="fas fa-edit"></i> ' . \Mobilemenuck\CKText::_('PLG_MOBILEMENUCK_EDIT', true) . '</div>';
		$html .= '<div class="btn btn-outline-secondary" onclick="jQuery(\'#' . $this->id . '\').val(\'\');jQuery(\'#' . $this->id . 'name\').val(\'\');"><i class="fas fa-times"></i> ' . \Mobilemenuck\CKText::_('PLG_MOBILEMENUCK_CLEAR', true) . '</div>';
		$html .= '</div>';
