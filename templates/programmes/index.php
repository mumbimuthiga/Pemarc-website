...
<section class="lower-menu">
            ...
            <div class="col-md-2">
                <div class="logo-container">
                    <a class="navbar-brand" href="<?php echo Uri::base(); ?>">
                        <img src="images/logo.png" alt="Zetech Logo">
                    </a>
                </div>
            </div>
    ...
    <section class="contents">
        <div class="container rounded shadow">
            <div class="row">
                <div class="col-md-12">
                    <jdoc:include type="modules" name="programmes" style="none" />
        ...
        <div class="container">
            <div class="footer-bottom-inner">
                ...
                <div class="footer-bottom-center">
                    © <?php echo date('Y'); ?> Zetech University | Inventing the Future. All Rights Reserved.
