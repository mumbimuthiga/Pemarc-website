...
use RegularLabs\Scoped\Psr\Http\Message\RequestInterface;
use RegularLabs\Scoped\Psr\Http\Message\ServerRequestInterface;
use RegularLabs\Scoped\Psr\Http\Message\StreamInterface;
use RegularLabs\Scoped\Psr\Http\Message\UriInterface;
final class Utils
{
    /**
