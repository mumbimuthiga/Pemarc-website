...
class Font extends \RegularLabs\Scoped\Intervention\Image\AbstractFont
{
    /**
    ...
    {
        throw new \RegularLabs\Scoped\Intervention\Image\Exception\NotSupportedException("Kerning is not supported by GD driver.");
    }
}
