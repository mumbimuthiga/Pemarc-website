...
use RegularLabs\Scoped\Intervention\Image\Gd\Color;
use RegularLabs\Scoped\Intervention\Image\Gd\Decoder;
class FillCommand extends AbstractCommand
{
    ...
    public function execute($image)
    {
        ...
        } catch (\RegularLabs\Scoped\Intervention\Image\Exception\NotReadableException $e) {
