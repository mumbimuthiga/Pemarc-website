    ...
    public static function getOrgImage($item_id, $article_images, $title, $introtext, $modulebase)
    {
        ...
        if ($article_images) {
            ...
            if ($orig_image != "") {
                ...
                return Uri::root() . '/modules/' . $modulebase . '/tmpl/assets/images/default.jpg';
            }
        }
    ...
    public static function getThumbnail($item_id, $article_images, $thumb_folder, $show_default_thumb, $thumb_width, $thumb_height, $title, $introtext, $modulebase)
    {
        ...
        if (!is_file($thumbPath)) {
            ...
            if ($orig_image != '' && file_exists($orig_image)) {
                ...
                if ($success) {
                    $thumb_img = '<img class="jtcs-image" src="' . Uri::root() . $thumb_folder . $thumb_name . '.' . $ext . '" alt="' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '" width="' . $thumb_width . '"/>';
                } else {
                    $thumb_img = '';
                }
            } else {
                ...
                if ($show_default_thumb) {
                    ...
                    if (file_exists($default_thumb)) {
                        ...
                        $thumb_img = '<img class="jtcs-image" src="' . Uri::root() . $thumb_folder . $thumb_name . '.jpg" alt="' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '" width="' . $thumb_width . '"/>';
                    } else {
                        $thumb_img = '';
                    }
                } else {
            ...
            $thumb_img = '<img class="jtcs-image" src="' . Uri::root() . $thumb_folder . $thumb_name . '.jpg" width="' . $thumb_width . '" alt="' . htmlspecialchars($title, ENT_QUOTES, 'UTF-8') . '" />';
        }
