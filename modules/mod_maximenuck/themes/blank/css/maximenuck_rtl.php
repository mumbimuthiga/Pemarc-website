...
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1 > span.nav-header {
	display:block;
    float : none !important;
	float : right;
    position:relative;
...
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1:hover > span.nav-header,
div#<?php echo $id; ?> ul.maximenuck li.maximenuck.level1.active > span.nav-header {
...
div#<?php echo $id; ?>.maximenuckh ul.maximenuck li.level1.parent > span.nav-header {
	padding-right: 12px;
}
...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent > span.nav-header:after {
	content: "";
	display: block;
	position: absolute;
	width: 0; 
...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent:hover > span.nav-header:after {
...
div#<?php echo $id; ?>.maximenuckv ul.maximenuck li.level1.parent > span.nav-header:after {
	display: inline-block;
	content: "";
	width: 0;
	height: 0;
...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent li.parent > span.nav-header:after,
...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent div.floatck.fixRight li.parent > span.nav-header:after,
...
div#<?php echo $id; ?> ul.maximenuck li.level1.parent.menu_right li.parent > span.nav-header:after {
	border-color: transparent #000 transparent transparent;
}
...
div#<?php echo $id; ?> ul.maximenuck2 li.maximenuck span.nav-header {
	display: block;
    float : none !important;
    float : right;
    position:relative;
