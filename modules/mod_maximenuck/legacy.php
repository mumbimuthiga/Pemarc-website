...
display: block !important;
	...
	if (file_exists('modules/mod_maximenuck/themes/' . $theme . '/css/ie7.css')) {
		echo '
			<!--[if lte IE 7]>
			<link href="' . \Maximenuck\CKUri::base(true) . '/modules/mod_maximenuck/themes/' . $theme . '/css/ie7.css" rel="stylesheet" type="text/css" />
			<![endif]-->';
	}
} else {
...
if ($templatelayer != -1)
	$document->addStyleSheet(\Maximenuck\CKUri::base(true) . '/modules/mod_maximenuck/templatelayers/' . $templatelayer . '.css');

// add responsive css
if ($orientation == 'horizontal' && $params->get('useresponsive', '1') == '1')
	$document->addStyleSheet(\Maximenuck\CKUri::base(true) . '/modules/mod_maximenuck/assets/maximenuresponsiveck.css');
...
if ($usejavascript && $params->get('layout', 'default') != '_:flatlist' && $params->get('layout', 'default') != '_:nativejoomla' && $params->get('layout', 'default') != '_:dropselect') {
	$document->addScript(\Maximenuck\CKUri::base(true) . '/modules/mod_maximenuck/assets/maximenuck.v8.js');
...
// add fancy effect
	if ($orientation == 'horizontal' && $usefancy == 1) {
		$document->addScript(\Maximenuck\CKUri::base(true) . '/modules/mod_maximenuck/assets/fancymenuck.v8.js');
...
if ($loadfontawesome && !$ckfontawesomeisloaded) {
	$document->addStyleSheet(\Maximenuck\CKUri::base(true) . '/modules/mod_maximenuck/assets/font-awesome.min.css');
